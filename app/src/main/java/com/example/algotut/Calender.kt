...
//        }
            ...
            },
            {
                ...
                Toast.makeText(this@Calender, "Failed to load data", Toast.LENGTH_SHORT).show()
            }
    ...
    private fun buildRecyclerView(contestData : ArrayList<Contest>){
        ...
        val listAdapter = ContestListAdapter(contestData, this@Calender)
        rvcalender.setHasFixedSize(true)

        rvcalender.layoutManager = LinearLayoutManager(this@Calender)
